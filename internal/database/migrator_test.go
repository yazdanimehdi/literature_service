...
func TestMigrator_Version(t *testing.T) {
	...
	t.Run("returns current version", func(t *testing.T) {
		...
		// If not, we get ErrNilVersion which is also acceptable
		if err != nil {
...
func TestMigrator_Up(t *testing.T) {
	...
	t.Run("up with no pending migrations returns nil", func(t *testing.T) {
		// Since migrations are already applied, this should return nil (no change)
		err := migrator.Up()
