...
func (m *mockKeywordRepo) GetPapersForKeyword(_ context.Context, _ uuid.UUID, _ uuid.UUID, _, _ int) ([]*domain.Paper, int64, error) {
	return nil, 0, nil
}
func (m *mockKeywordRepo) GetPapersForKeywordAndSource(_ context.Context, _ uuid.UUID, _ uuid.UUID, _ domain.SourceType, _, _ int) ([]*domain.Paper, int64, error) {
	return nil, 0, nil
}
